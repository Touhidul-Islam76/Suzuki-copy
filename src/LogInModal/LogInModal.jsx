...
const LogInModal = ({onClose}) => {
  ...
  return (
     <div ref={closeRef} onClick={Closingclick} className='fixed h-screen w-screen inset-0 bg-black bg-opacity-5 backdrop-blur-sm flex justify-center items-center '>
        <div className=''>
        
        <div className="modal rounded-[20px] bg-black p-4 pb-8 text-white w-[400px] h-[100%] flex flex-col gap-4 items-center justify-center">
